...
- [基于 kubeadm 安装 kubernetes 1.8.3](#org7b69304)
  - [环境](#org486d3e8)
  - [准备工作](#org8d8737e)
    - [firewall 设置](#org91d489c)
    - [host 信息设置](#org10584f9)
  - [安装二进制文件](#orgf31f24a)
    - [设置 kubernetes repos](#org938c55f)
    - [设置翻墙](#org2acf49a)
  - [安装 k8s 主要组件](#orgb79b1da)
    - [所需镜像列表](#orge022d34)
    - [拉去镜像](#org7264766)
    - [kubeadm init](#org95d04ce)
  - [calico 安装](#org4d0b5d7)
  - [节点添加](#orgc76badb)
  - [安装过程出现的问题](#org789f362)
    - [kube-dns](#orgcacc49a)
  - [扩展阅读](#orgea19e72)
...
假如不生效的话， 有肯定防火墙没有关闭, `systemctl disable firewalld` 关闭后， reboot 重启试下,经过排查，造成这个问题的原因是 kube-proxy 设置 ipvs 造成的。
